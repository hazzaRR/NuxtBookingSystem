    ...
    <div>
       ...
       <div v-else>
           ...
           <form class="grid place-items-center" @submit.prevent>
                ...
                <p class="input input-bordered w-full max-w-xs flex items-center input-disabled input-sm md:input-md"> {{ appointmentDetails.firstname + " " + appointmentDetails.surname }}</p>
                </div>
                ...
                <p class="input input-bordered w-full max-w-xs flex items-center input-disabled input-sm md:input-md"> {{ appointmentDetails.telephone }}</p>
                </div>
                <div class="form-control w-full max-w-xs">
                <label class="label">
                <span class="label-text">Service</span>
                </label>
                    <select class="input input-bordered w-full max-w-xs select-sm md:select-md" id="service" v-model="selectedService">
                ...
                <div class="flex space-x-2">
                    <input type="time" class="input input-bordered w-1/2 max-w-xs input-sm md:input-md" v-model="startTime"/>
                    <span class="flex items-center">-</span>
                    <input type="time" class="input input-bordered w-1/2 max-w-xs input-sm md:input-md" v-model="endTime"/>
                </div>
                </div>
                <div class="relative mb-6">
