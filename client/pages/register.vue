<template>
    <div>
        <div v-if="registerError" class="alert alert-warning">
...
const register = async (event) => {
    ...
    if (!checkPassword(password.value)) {
        ...
        errorMessage.value = "Password doesn't meet requirements, password must contain -1 Uppercase,1 Lowercase,1 Number,1 Symbol(!@#$%^&*_=+-), Min 8,Max 25";
