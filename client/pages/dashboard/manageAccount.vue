<template>
    <div>
        ...
        <div v-if="setting === 'updateEmail'">
            <ChangeEmail :currentEmail="email" route="client" :csrfToken="csrf_token" @update:successMessage="successMessage = $event" @update:errorMessage="errorMessage = $event" @update:serverMessage="serverMessage = $event"/>
        </div>
        ...
        <div v-else-if="setting === 'updatePersonalDetails'">
            <UpdatePersonalDetails :currentFirstname="firstname" :currentSurname="surname" :currentTelephone="telephone" route="client" :csrfToken="csrf_token" @update:successMessage="successMessage = $event" @update:errorMessage="errorMessage = $event" @update:serverMessage="serverMessage = $event"/>
        </div>
